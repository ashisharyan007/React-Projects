...
const Navbar = () => {
  ...
  // Scroll functionality with smooth transition
    ...
    ${isScrolled ? "bg-[#050414] bg-opacity-50 backdrop-blur-md shadow-md" : "bg-transparent"}`}>
      ...
      <div className='text-white py-5 flex justify-between items-center'>
        ...
        <div className='hidden md:flex space-x-4'>
          <a href="https://github.com/ashisharyan007" target='_blank' className='text-gray-300 hover:text-[#8245ec]'>
            <FaGithub size={24} />
          </a>
          <a href="https://www.linkedin.com/in/ashish-aryan-5b5b4b239" target='_blank' className='text-gray-300 hover:text-[#8245ec]'>
            <FaLinkedin size={24} />
          </a>
        ...
        <div className='absolute top-16 left-1/2 transform -translate-x-1/2 w-4/5 bg-[#050414] bg-opacity-50 backdrop-filter backdrop-blur-lg z-50 rounded-lg shadow-lg md:hidden'>
          <ul className='flex flex-col items-center space-y-4 py-4 text-gray-300'>
            ...
            <div className='flex space-x-4'>
              <a href="https://github.com/ashisharyan007" target='_blank' className='text-gray-300 hover:text-white'>
                <FaGithub size={24} />
              </a>
              <a href="https://www.linkedin.com/in/ashish-aryan-5b5b4b239" target='_blank' className='text-gray-300 hover:text-white'>
                <FaLinkedin size={24} />
              </a>
            </div>
